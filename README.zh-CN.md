...
**发布状态：** v1.0.0 已发布，用于文档所述的本地合成数据作品集演示。发布批准人已明确接受[发布清单](docs/release/RELEASE_CHECKLIST.zh-CN.md)中记录的例外：未记录 BA-01–BA-08 的产品负责人决策与 UAT 产物，且没有已批准的性能目标。工程测试通过仅验证合成数据演示；不代表本项目是生产 MES、合规工具或机密数据服务。
